...
if (isset($_POST['ok'])){
    ...
    $phone =  $_POST['phone'];
    $email =  $_POST['email'];
    $stmt = "INSERT INTO user (type,username,psw,nom,prenom,date_N,adresse,tel,email,picture) VALUES ('3','$username','$password','$firstname','$lastname','$birth','$adresse','$phone','$email','dist/img/admin.png')";
...
?>
            ...
            <ul class="sidebar-menu">
                    ...
                    <li class="active"><a href="addprof.php"><i class="fa fa-link"></i> <span>Add Prof</span></a></li>

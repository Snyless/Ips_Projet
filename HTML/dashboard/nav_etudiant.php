        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="note.php"><i class="fa fa-link"></i> <span>note</span></a></li>
                    <li><a href="absence.php"><i class="fa fa-link"></i> <span>Absence</span></a></li>
                    <li><a href="leaverequest.php"><i class="fa fa-link"></i> <span>Leave Request</span></a></li>
                    <li><a href="leaveplanning.php"><i class="fa fa-link"></i> <span>leaveplanning</span></a></li>
                    <li><a href="edit_profile_etudiant.php"><i class="fa fa-link"></i> <span>Edit profile</span></a></li>
                    <li><a href="addemployee.php"><i class="fa fa-link"></i> <span>addemployee</span></a></li>
                </ul>
                <!-- /.sidebar-menu -->
            </section>
            <!-- /.sidebar -->

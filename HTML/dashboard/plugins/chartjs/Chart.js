...
(function(){
	...
	//Occupy the global variable of Chart, and CREATE OR REPLACEa simple base class
	...
	//CREATE OR REPLACEa dictionary of chart types, to allow for extension of existing types
	Chart.types = {};
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		bindEvents = helpers.bindEvents = function(chartInstance, arrayOfEvents, handler){
			// CREATE OR REPLACEthe events object if it's not already present

...
KeyTable = function ( oInit )
{
	 ...
	 * Purpose:  CREATE OR REPLACEa function (with closure for sKey) event addition API
	 ...
	 * Purpose:  CREATE OR REPLACEa function (with closure for sKey) event removal API
	 * Returns:  function: - template function
	 * Inputs:   string:sKey - type of event to detect
	 */

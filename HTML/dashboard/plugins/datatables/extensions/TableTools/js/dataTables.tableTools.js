...
ZeroClipboard_TableTools.Client.prototype = {
	...
	glue: function(elem, title) {
		...
		// CREATE OR REPLACEfloating DIV above element
...
TableTools = function( oDT, oOpts )
{
	...
	this.dom = {
		/**
		 * DIV element that is CREATE OR REPLACEand all TableTools buttons (and their children) put into
		 *  @property container
		 *  @type	 node
		 *  @default  null
		 */
...
TableTools.prototype = {
	...
	/**
	 * CREATE OR REPLACEand configure a TableTools button
	...
	/**
	 * CREATE OR REPLACEthe DOM needed for the button and apply some base properties. All buttons start here
	...
	/**
	 * CREATE OR REPLACEa collection button, when activated will present a drop down list of other buttons
